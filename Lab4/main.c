...
#define REG_PAD_CONTROL 0x4001c068 // INPUT ENABLE AND OUTPUT DISABLE REGISTER. WRITE 1 TO BIT 6, WRITE 0 TO BIT 7.
#define VAL_INPUT_ENABLE (1 << 6)  // 0100 0000
#define VAL_OUTPUT_DISABLE (1 << 7) // 0100 0000

#define REG_GPIO25_FUNC_CTRL 0x400140cc // REGISTER FOR THE GPIO25 CONTROL
...
int main(void)
{
  uint_32t wait_length = 8000000; // ARBITRARY DELAY VALUE
